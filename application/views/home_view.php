            ...
            <div class="overlay d-flex flex-column  ">
                <div class="row text-center no-gutters">
                    <div class="col-12 main-text ">
                        <h1>Genipharm</h1>
                        <p>L'intégrité, la responsabilité et la performance.</p>
                        <!-- <a class="btn btn-primary btn-produit" href="<?php echo base_url(); ?>page/compliments">DECOUVREZ NOS PRODUITS</a>   -->
                    </div>
                </div>
            </div>
...
<!-- Begin A qui somme nous  -->
<div class="container-fluid    aboutus " id="somme">
    <div class="container ">
        <div class="row second-row">
            <div class="col-md-6 div-image ">
                <div class="labo-img">
                    <img src="Assets/img/laboh.jpg" alt="labo">
...
<div class="container-fluid big-section " id="big-section">
    ...
    <img src="Assets/img/h1.svg" class="img-svg1" alt="skin">
    <img src="Assets/img/h2.svg" class="img-svg2" alt="skin">
...
<div class="container-fluid    aboutus " id="somme">
    <div class="container ">
        <div class="row second-row">
            ...
            <div class="col-md-6 div-image ">
                <div class="labo-img">
                    <img src="Assets/img/lab2.jpg" alt="labo">
                    <div class="overlay"></div>
                </div>
            </div>
...
<div class="container-fluid galerie pt-4 pb-4" id="galerie">
    ...
    <div id="carouselExampleFade" class=" d-flex carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item car-two "></div>
